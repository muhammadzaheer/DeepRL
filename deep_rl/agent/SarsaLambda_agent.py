...
class SarsaAgent(BaseAgent):
    ...
    def start(self):
        ...
        self.ts = self.tiles_rep.get_representation(state[0]) if self.config.tile_coding else state[0]
    ...
    def step(self):
        ...
        self.tns = self.tiles_rep.get_representation(next_state[0]) if self.config.tile_coding else next_state[0]
    ...
    def eval_step(self, state):
        ...
        state = self.tiles_rep.get_representation(state[0]) if self.config.tile_coding else state[0]
...
class SarsaStepSizeAgent(BaseAgent):
    def __init__(self, config):
        BaseAgent.__init__(self, config)
        self.config = config
